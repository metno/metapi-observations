CREATE TABLE KPORTAL.T_KDVH_USEINFO_FLAG
(
  USEINFO_ID    NUMBER(10)                      NOT NULL,
  USEINFO_NAME VARCHAR2(150 BYTE)              NOT NULL,
  USEINFO_FLAG  NUMBER(10)                      NOT NULL,
  DESCRIPTION   VARCHAR2(200 BYTE)              NOT NULL,
  LANGUAGE          VARCHAR2(2 BYTE)
);
GRANT SELECT ON KPORTAL.T_KDVH_USEINFO_FLAG TO PUBLIC;
...
CREATE TABLE KPORTAL.T_KDVH_USER_FLAG
(
  FLAG_LEVEL        NUMBER(10)                  NOT NULL,
  FLAG_TEXT         VARCHAR2(100 BYTE),
  FLAG_CODE         VARCHAR2(10 BYTE),
  LANGUAGE          VARCHAR2(2 BYTE),
  FLAG_DESCRIPTION  VARCHAR2(200 CHAR)
);
